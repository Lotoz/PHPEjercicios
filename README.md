...
*[PHP SuperIndex](https://lotoz.github.io/PHPEjercicios/superIndex.html)*

![php imagen](./assets/banner.jpg)
...
**Si usas el sitio web *PHP SuperIndex* es mas comodo para recorrer todo el repositorio, ya que cada link dentro de los indices te enviara al codigo para que puedas verlo sin dificultad.**
