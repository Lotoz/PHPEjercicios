     ...
     <div class="d-flex justify-content-center aling-items-center mt-5">
        ...
        <form class="p-3 shadow rounded" action="calculo.php" method="post" id="formulario">
            ...
            <div class=mb-3>
                ...
                <input class="rounded" onchange="clearError(nota1)" type="text"  id="nota1" name="nota1" placeholder="2 cifras decimales">
            </div>
            <div>
                <label class="form-label" for="number2">Nota 2:<span class="text-danger">*<span></label>
                <input class="rounded" onchange="clearError(nota2)" type="text" id="nota2" name="nota2" placeholder="2 cifras decimales">
            ...
            <div>
                ...
                <input class="rounded" onchange="clearError(faltas)" type="text" id="faltas" name="faltas" placeholder="2 cifras decimales">
